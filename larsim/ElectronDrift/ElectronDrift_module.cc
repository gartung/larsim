...
void larg4::ElectronDrift::produce(art::Event & e)
{
  ...
  for(auto const& edep : edep_vec){
    ...
    edep_XYZ[0] = edep.xpos; edep_XYZ[1] = edep.ypos; edep_XYZ[2] = edep.zpos;
    
    XYZ[0] = edep.xpos; //we won't need to validate x position: that will show up as timing diff, that's all
