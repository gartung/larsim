...
namespace larg4{
  ...
  //----------------------------------------------------------------------------
  void ISCalculationSeparate::CalculateIonization(sim::SimEDep const& edep){
    CalculateIonization(edep.energy,edep.ds,
  ...
  //----------------------------------------------------------------------------
  void ISCalculationSeparate::CalculateScintillation(sim::SimEDep const& edep)
  {
    CalculateScintillation(edep.energy,edep.pdgCode);
  }

  //----------------------------------------------------------------------------
  void ISCalculationSeparate::CalculateIonizationAndScintillation(sim::SimEDep const& edep)
  {
  ...
  //----------------------------------------------------------------------------
  void ISCalculationSeparate::CalculateIonizationAndScintillation(sim::SimEDep const& edep, std::vector<double> const& efieldOffsets)
  {
    fEnergyDeposit = edep.energy;
  ...
  double ISCalculationSeparate::EFieldAtStep(double fEfield, sim::SimEDep const& edep)
  {
    return EFieldAtStep(fEfield,edep.xpos,edep.ypos,edep.zpos);
  }
  ...
  double ISCalculationSeparate::EFieldAtStep(double fEfield, sim::SimEDep const& edep, std::vector<double> const& efieldOffsets)
  {
    return EFieldAtStep(fEfield,edep.xpos,edep.ypos,edep.zpos,efieldOffsets);
  }
