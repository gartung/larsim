...
namespace sim { class SimEDep; class LArG4Parameters; }
...
namespace larg4 {
 ...
 public:
   ...
   void   Reset();
   void   CalculateIonizationAndScintillation(sim::SimEDep const& edep);
   void   CalculateIonizationAndScintillation(sim::SimEDep const& edep, std::vector<double> const&);
   ...
   double EFieldAtStep(double fEfield, sim::SimEDep const& edep); //value of field with any corrections for this step  
   double EFieldAtStep(double fEfield, sim::SimEDep const& edep, std::vector<double> const&); //value of field with any corrections for this step  
 ...
 private:
   ...
   void CalculateIonization(sim::SimEDep const& edep);

   void CalculateIonization(float e, float ds, float x, float y, float z, std::vector<double> const&);
   void CalculateIonization(sim::SimEDep const& edep, std::vector<double> const&);

   void CalculateScintillation(float e, int pdg);
   void CalculateScintillation(sim::SimEDep const& edep);
